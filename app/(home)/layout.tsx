...
// Lazy load the mobile navbar with proper SSR handling
...
export default function RootLayout({
  ...
  // Initialize client state and scroll handler
  useEffect(() => {
    setIsClient(true);
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-10 mb-10">
            <div className="flex flex-col items-center lg:items-start">
              ...
              <p className="text-background/80 text-sm max-w-xs text-center lg:text-left">
                We are serving since 2003 ({new Date().getFullYear() - 2003}
                {"+ "}
                Years)
              </p>
            </div>
